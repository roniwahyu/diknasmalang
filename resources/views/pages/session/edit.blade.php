...
<?php
    $pageTitle = __('editSession'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('editSession') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("session/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id-holder" class=" ">
                                            <input id="ctrl-id" data-field="id"  value="<?php  echo $data['id']; ?>" type="text" placeholder="{{ __('enterId') }}"  required="" name="id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-timestamp-holder" class=" ">
                                            <input id="ctrl-timestamp" data-field="timestamp"  value="<?php  echo $data['timestamp']; ?>" type="number" placeholder="{{ __('enterTimestamp') }}" step="any"  required="" name="timestamp"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-data-holder" class=" ">
                                            <div class="dropzone required" input="#ctrl-data" fieldname="data" uploadurl="{{ url('fileuploader/upload/data') }}"    data-multiple="false" dropmsg="{{ __('chooseFilesOrDropFilesHere') }}"    btntext="{{ __('browse') }}" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                <input name="data" id="ctrl-data" data-field="data" required="" class="dropzone-input form-control" value="<?php  echo $data['data']; ?>" type="text"  />
                                                <!--<div class="invalid-feedback animated bounceIn text-center">{{ __('pleaseAChooseFile') }}</div>-->
                                                <div class="dz-file-limit animated bounceIn text-center text-danger"></div>
                                            </div>
                                        </div>
                                        <?php Html :: uploaded_files_list($data['data'], '#ctrl-data'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
