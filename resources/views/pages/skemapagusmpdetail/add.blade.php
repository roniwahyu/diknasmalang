...
<?php
    $pageTitle = __('addNewSkemaPaguSmpDetail'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('addNewSkemaPaguSmpDetail') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="skemapagusmpdetail-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('skemapagusmpdetail.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-id_sekolah-holder" class=" ">
                                                <input id="ctrl-id_sekolah" data-field="id_sekolah"  value="<?php echo get_value('id_sekolah') ?>" type="number" placeholder="{{ __('enterIdSekolah') }}" step="any"  name="id_sekolah"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
