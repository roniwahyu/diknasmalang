...
<?php
    $pageTitle = __('editGroupsPermission'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('editGroupsPermission') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("groupspermissions/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="groups_id">{{ __('groupsId') }} </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <div id="ctrl-groups_id-holder" class=" ">
                                            <input id="ctrl-groups_id" data-field="groups_id"  value="<?php  echo $data['groups_id']; ?>" type="number" placeholder="{{ __('enterGroupsId') }}" step="any"  name="groups_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
