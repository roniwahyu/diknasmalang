...
<?php
    ...
    $pageTitle = __('penganggaranTahun2024'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('penganggaran2024') }}</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="penganggaran2024-list-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/penganggaran2024/", $field_name, $field_value); ?>
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-subkegiatan" > {{ __('subkegiatan') }}</th>
                                        <th class="td-norek" > {{ __('norek') }}</th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-parentid">
                                            <?php echo  $data['parentid'] ; ?>
                                        </td>
                                        <td class="td-subkegiatanasli">
                                            <?php echo  $data['subkegiatanasli'] ; ?>
                                        </td>
                                        <td class="td-statussubkegiatan">
                                            <?php echo  $data['statussubkegiatan'] ; ?>
                                        </td>
                                        <td class="td-statusrincian">
                                            <?php echo  $data['statusrincian'] ; ?>
                                        </td>
                                        <td class="td-subkegiatan">
                                        ...
                                        <td class="td-btn">
                                            <div class="dropdown" >
                                                ...
                                                <ul class="dropdown-menu">
                                                    <?php if($can_view){ ?>
                                                    <a class="dropdown-item "   href="<?php print_link("penganggaran2024/view/$rec_id"); ?>" >
