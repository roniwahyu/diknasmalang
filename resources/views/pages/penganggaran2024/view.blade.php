                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            <div class="page-data">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <a class="btn btn-sm btn-success has-tooltip "   title="{{ __('edit') }}" href="<?php print_link("penganggaran2024/edit/$rec_id"); ?>" >
                                    <i class="fa fa-edit"></i> {{ __('edit') }}
                                </a>
                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" title="{{ __('delete') }}" href="<?php print_link("penganggaran2024/delete/$rec_id?redirect=penganggaran2024"); ?>" >
