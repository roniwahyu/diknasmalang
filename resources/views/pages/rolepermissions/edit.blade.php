...
<?php
    $pageTitle = __('editRolePermission'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('editRolePermission') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("rolepermissions/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-perm_id-holder" class=" ">
                                            <input id="ctrl-perm_id" data-field="perm_id"  value="<?php  echo $data['perm_id']; ?>" type="number" placeholder="{{ __('enterPermId') }}" step="any"  name="perm_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-permissions-holder" class=" ">
                                            <input id="ctrl-permissions" data-field="permissions"  value="<?php  echo $data['permissions']; ?>" type="text" placeholder="{{ __('enterPermissions') }}"  name="permissions"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-name-holder" class=" ">
                                            <input id="ctrl-name" data-field="name"  value="<?php  echo $data['name']; ?>" type="text" placeholder="{{ __('enterName') }}"  name="name"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-module_id-holder" class=" ">
                                            <input id="ctrl-module_id" data-field="module_id"  value="<?php  echo $data['module_id']; ?>" type="number" placeholder="{{ __('enterModuleId') }}" step="any"  name="module_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-class-holder" class=" ">
                                            <input id="ctrl-class" data-field="class"  value="<?php  echo $data['class']; ?>" type="text" placeholder="{{ __('enterClass') }}"  name="class"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-method-holder" class=" ">
                                            <input id="ctrl-method" data-field="method"  value="<?php  echo $data['method']; ?>" type="text" placeholder="{{ __('enterMethod') }}"  name="method"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-params-holder" class=" ">
                                            <input id="ctrl-params" data-field="params"  value="<?php  echo $data['params']; ?>" type="text" placeholder="{{ __('enterParams') }}"  name="params"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-userid-holder" class=" ">
                                            <input id="ctrl-userid" data-field="userid"  value="<?php  echo $data['userid']; ?>" type="number" placeholder="{{ __('enterUserid') }}" step="any"  name="userid"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
